...
**Instructors:** Please refer to [https://github.com/ladieslearningcode/llc-slidedeck-template] for instructions for customization of the slide deck and features. If there are any issues or fixes required for this workshop slide presentation, please open an issue, submit a pull request or email me at [christina@ladieslearningcode.com](mailto:christina@ladieslearningcode.com).
